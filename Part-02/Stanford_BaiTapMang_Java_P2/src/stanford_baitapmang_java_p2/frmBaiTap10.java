 ...
 * @author dangquang
 */
public class frmBaiTap10 extends javax.swing.JFrame {

    /**
     * Creates new form frmBaiTap10
     */
    public frmBaiTap10() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Nhập số nhị phân cần chuyển"));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtSoNhiPhan, javax.swing.GroupLayout.PREFERRED_SIZE, 283, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    /**
     * Xử lý chuyển từ số nhị phân sang thập phân
     * @param evt 
     */
    private void btnChuyenDoiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChuyenDoiActionPerformed
        ...
        soNhiPhan = txtSoNhiPhan.getText();
        
        //Chuyển về mảng kí tự
        char arrKiTu[] = soNhiPhan.toCharArray();
        
        //Sử dụng vòng lặp để đưa về số thập phân
        for(int i = 0; i < arrKiTu.length; i++)
        {
            if(arrKiTu[i] == '1'){
                soThapPhan += Math.pow(2, arrKiTu.length - i - 1);
            }
        }
        ...
        //Sử dụng hàm
        int soThapPhan2 = Integer.parseInt(soNhiPhan, 2);
        
        System.out.println("Số thập phân lấy được là: " + soThapPhan2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmBaiTap10.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmBaiTap10().setVisible(true);
            }
        });
    }
